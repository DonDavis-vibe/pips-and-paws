...
export const CREATURES = [
  {
    key: 'cat', name: { de: 'Katze', en: 'Cat' }, hp: 15, armour: 1, dmg: 8, wil: 10,
  ...
  {
    key: 'faerie', name: { de: 'Fee', en: 'Faerie' }, hp: 6, armour: 0, dmg: 8, wil: 15,
