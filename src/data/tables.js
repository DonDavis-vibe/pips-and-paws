...
export const BIRTHSIGNS = [
  ...
  { sign: { de: 'Sturm', en: 'Storm' }, disposition: { de: 'Großzügig / Jähzornig', en: 'Generous / Wrathful' } },
  { sign: { de: 'Mond', en: 'Moon' }, disposition: { de: 'Weise / Geheimnisvoll', en: 'Wise / Mysterious' } },
  { sign: { de: 'Mutter', en: 'Mother' }, disposition: { de: 'Fürsorglich / Besorgt', en: 'Nurturing / Worrying' } },
];
...
export const DETAILS = [
  { de: 'Vernarbter Körper', en: 'Scarred body' },
  { de: 'Beleibter Körper', en: 'Corpulent body' },
  { de: 'Skelettartiger Körper', en: 'Skeletal body' },
  { de: 'Weidenschlanker Körper', en: 'Willowy body' },
  { de: 'Winziger Körper', en: 'Tiny body' },
  { de: 'Massiger Körper', en: 'Massive body' },
  { de: 'Kriegsbemalung', en: 'War paint' },
  { de: 'Fremdländische Kleidung', en: 'Foreign clothes' },
  ...
  { de: 'Klötziges Gesicht', en: 'Lumpy face' },
  { de: 'Schönes Gesicht', en: 'Beautiful face' },
  ...
  { de: 'Büscheliger Schwanz', en: 'Tufted tail' },
