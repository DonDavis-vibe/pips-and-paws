...
export const BIRTHSIGNS = [
  ...
  { sign: { de: 'Sturm', en: 'Storm', es: 'La Tormenta' }, disposition: { de: 'Großzügig / Jähzornig', en: 'Generous / Wrathful', es: 'Generoso / Iracundo' } },
  { sign: { de: 'Mond', en: 'Moon', es: 'La Luna' }, disposition: { de: 'Weise / Geheimnisvoll', en: 'Wise / Mysterious', es: 'Sabio / Misterioso' } },
  { sign: { de: 'Mutter', en: 'Mother', es: 'La Madre' }, disposition: { de: 'Fürsorglich / Besorgt', en: 'Nurturing / Worrying', es: 'Protector / Preocupado' } },
];
...
export const COAT_PATTERNS = [
  ...
  { de: 'gebändert', en: 'Banded', es: 'A rayas' },
...
export const DETAILS = [
  { de: 'Vernarbter Körper', en: 'Scarred body', es: 'Cicatrices' },
  { de: 'Beleibter Körper', en: 'Corpulent body', es: 'Corpulento' },
  { de: 'Skelettartiger Körper', en: 'Skeletal body', es: 'Esquelético' },
  { de: 'Weidenschlanker Körper', en: 'Willowy body', es: 'Esbelto' },
  { de: 'Winziger Körper', en: 'Tiny body', es: 'Diminuto' },
  { de: 'Massiger Körper', en: 'Massive body', es: 'Enorme' },
  { de: 'Kriegsbemalung', en: 'War paint', es: 'Pintura de guerra' },
  { de: 'Fremdländische Kleidung', en: 'Foreign clothes', es: 'Ropajes extranjeros' },
  ...
  { de: 'Klötziges Gesicht', en: 'Lumpy face', es: 'Rostro abultado' },
  { de: 'Schönes Gesicht', en: 'Beautiful face', es: 'Rostro hermoso' },
  ...
  { de: 'Gefärbtes Fell', en: 'Dyed fur', es: 'Pelaje teñido' },
  ...
  { de: 'Büscheliger Schwanz', en: 'Tufted tail', es: 'Cola anudada' },
